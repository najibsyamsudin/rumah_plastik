...
<body>
    <header>
        ...
        <div class="header-right">
            <a href="<?php echo base_url('Order_Controller_Admin/pindah/order'); ?>">Order</a>
            <a href="<?php echo base_url('Order_Controller_Admin/pindah/user'); ?>">Dashboard</a>
        </div>
    </header>
<div class="container">
        <nav class="wrapper">
    ...
    <div class="fContainer">
        <form action="<?php echo base_url('insert_order_admin'); ?>" method="post">
            <div class="for">
